...
useGLTF.preload('/3d/gltf/Phone.gltf')
    ...
    return (
      <group {...props} ref={group} dispose={null}>
        <group position={[-0.056, 0.339, 0.147]} rotation={[-0.228, -0.438, 0.205]} scale={[1, 1.161, 1]}>
          <mesh geometry={nodes.objMesh_1.geometry} material={materials.Cel}   />
          <mesh geometry={nodes.objMesh_2.geometry} material={materials.Camara} />
          <mesh geometry={nodes.objMesh_3.geometry} material={materials.Blanco} />
          <mesh geometry={nodes.objMesh_4.geometry} material={materials.Emission}  />
        </group>
      </group>
    )
  }
